...
import static com.faforever.client.event.EventService.EVENT_AEON_PLAYS;
import static com.faforever.client.event.EventService.EVENT_AEON_WINS;
import static com.faforever.client.event.EventService.EVENT_BUILT_AIR_UNITS;
import static com.faforever.client.event.EventService.EVENT_BUILT_LAND_UNITS;
import static com.faforever.client.event.EventService.EVENT_BUILT_NAVAL_UNITS;
import static com.faforever.client.event.EventService.EVENT_BUILT_TECH_1_UNITS;
import static com.faforever.client.event.EventService.EVENT_BUILT_TECH_2_UNITS;
import static com.faforever.client.event.EventService.EVENT_BUILT_TECH_3_UNITS;
import static com.faforever.client.event.EventService.EVENT_CYBRAN_PLAYS;
import static com.faforever.client.event.EventService.EVENT_CYBRAN_WINS;
import static com.faforever.client.event.EventService.EVENT_SERAPHIM_PLAYS;
import static com.faforever.client.event.EventService.EVENT_SERAPHIM_WINS;
import static com.faforever.client.event.EventService.EVENT_UEF_PLAYS;
import static com.faforever.client.event.EventService.EVENT_UEF_WINS;
...
public class UserInfoWindowController implements Controller<Node> {
  ...
  private Map<String, Achievement> achievementById;
  private Window ownerWindow;


  public UserInfoWindowController(StatisticsService statisticsService, CountryFlagService countryFlagService,
                                  AchievementService achievementService, AchievementImageService achievementImageService, EventService eventService, I18n i18n,
  ...
  private void setAvailableAchievements(List<Achievement> achievements) {
    ...
    achievements.forEach(achievement -> {
      ...
      achievementById.put(achievement.getId(), achievement);
      achievementItemById.put(achievement.getId(), controller);
  ...
  private void updatePlayerAchievements(List<? extends PlayerAchievement> playerAchievements) {
    ...
    if (mostRecentPlayerAchievement == null) {
      ...
      Achievement mostRecentAchievement = achievementById.get(mostRecentPlayerAchievement.getAchievement().getId());
      ...
      Platform.runLater(() -> {
        ...
        mostRecentAchievementImageView.setImage(achievementImageService.getImage(mostRecentAchievement, AchievementState.UNLOCKED));
      });
    }
  }
  ...
  private void plotPlayerRatingGraph(List<RatingHistoryDataPoint> dataPoints) {
    List<XYChart.Data<Integer, Integer>> values = dataPoints.stream()
      .map(datapoint -> new Data<>(dataPoints.indexOf(datapoint), datapoint.getRank()))
    ...
    series.setName(i18n.get("userInfo.rankOverTime"));
