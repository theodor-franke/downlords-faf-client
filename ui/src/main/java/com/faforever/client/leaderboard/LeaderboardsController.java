...
public class LeaderboardsController extends AbstractViewController<Node> {
  ...
  public void initialize() {
    ladder1v1LeaderboardController.setLeaderboardName(KnownFeaturedMod.LADDER_1V1.getTechnicalName());
    globalLeaderboardController.setLeaderboardName(KnownFeaturedMod.FAF.getTechnicalName());
