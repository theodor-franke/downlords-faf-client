 ...
 */
// TODO Rethink whether this should be in the "service" module and where to put it if not
public final class JavaFxUtil {
  ...
  public static void fixJDK8089296() {
    ...
    int newStyle = user32.GetWindowLong(hwnd, WinUser.GWL_STYLE) | 0x00020000; //WS_MINIMIZEBOX
