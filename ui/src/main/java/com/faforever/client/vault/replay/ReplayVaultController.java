...
public class ReplayVaultController implements Controller<Node> {
  ...
  public TableColumn<Replay, FaMap> mapColumn;


  // TODO reduce dependencies
  public ReplayVaultController(NotificationService notificationService, ReplayService replayService, MapPreviewService mapPreviewService, TaskService taskService, I18n i18n, TimeService timeService, ReportingService reportingService, ApplicationContext applicationContext, UiService uiService) {
  ...
  private TableCell<Replay, FaMap> mapCellFactory(TableColumn<Replay, FaMap> column) {
    ...
    TableCell<Replay, FaMap> cell = new TableCell<>() {

      @Override
      protected void updateItem(FaMap map, boolean empty) {
        ...
        if (empty || map == null) {
          ...
          imageView.setImage(mapPreviewService.loadPreview(map.getFolderName(), PreviewSize.SMALL));
