...
public class LeaderboardController extends AbstractViewController<Node> {
  ...
  protected void onDisplay(NavigateEvent navigateEvent) {
    Assert.checkNullIllegalState(leaderboardName, "ratingType must not be null");

    contentPane.setVisible(false);
    leaderboardService.getEntries(leaderboardName).thenAccept(leaderboardEntryBeans -> {
