...
interface IceAdapterApi {
   ...
   *
   * @param iceServers A list of IceServers, each IceServer maps from key (e.g. username, credential, url(s)) -> value where value can can be a string or list of strings
   */
