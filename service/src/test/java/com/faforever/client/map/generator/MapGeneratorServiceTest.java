...
public class MapGeneratorServiceTest extends AbstractPlainJavaFxTest {
  ...
  public void testWrongMapNameThrowsException() {
    ...
    expectedException.expectMessage(startsWith("Doesn't match pattern"));
    instance.generateMap(testMapNameUnsupportedVersion).join();
  }
  ...
  public void testWrongVersionThrowsException() {
    ...
    instance.generateMap(unsupportedVersion, seed).join();
  }
}
