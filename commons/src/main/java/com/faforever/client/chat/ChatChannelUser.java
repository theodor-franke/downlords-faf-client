...
public class ChatChannelUser {
  ...
  public ChatChannelUser setPlayer(Player player) {
  ...
  public ChatChannelUser setColor(Color color) {
  ...
  public ChatChannelUser setModerator(boolean moderator) {
  ...
  public ChatChannelUser setLastActive(Instant lastActive) {
