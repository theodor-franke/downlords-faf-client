...
public class ReplayDetailControllerTest extends AbstractPlainJavaFxTest {
  ...
  public void setUp() throws Exception {
    instance = new ReplayDetailController(timeService, i18n, uiService, replayService, mapPreviewService, playerService, reviewService, clientProperties);
  ...
  public void onDownloadMoreInfoClicked() throws Exception {
    ...
    review.setReviewer(new Player("junit"));
