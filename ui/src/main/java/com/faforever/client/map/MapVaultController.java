...
public class MapVaultController extends AbstractViewController<Node> {
  ...
  private Supplier<CompletableFuture<List<FaMap>>> currentSupplier;
  ...
  public void initialize() {
    ...
    searchController.setRootType(org.supcomhub.api.dto.Map.class);
  ...
  private void replaceSearchResult(List<FaMap> maps, Pane pane) {
  ...
  private void onShowMapDetail(FaMap map) {
  ...
  private void appendSearchResult(List<FaMap> maps, Pane pane) {
  ...
  private void displayMapsFromSupplier(Supplier<CompletableFuture<List<FaMap>>> mapsSupplier) {
    currentPage = 0;
  ...
  private void displayMaps(List<FaMap> maps) {
